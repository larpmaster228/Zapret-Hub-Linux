...
Сохраните сайт на случай блокировки GitHub в РФ: там всегда доступна последняя версия.
👇👇👇
...
**Zapret Hub** — единое Windows-приложение для разных способов доступа к сайтам, приложениям и сервисам.
...
Zapret Hub подходит и тем, кто уже знает, чем отличаются DPI-обход, VPN и DNS, и тем, кому просто нужно снова открыть YouTube, Discord, игру или другой сервис.
...
- ✅ не собирает пользовательские данные, в том числе анонимную аналитику.
...
1. **Выберите основной способ подключения.** Доступны Zapret, Zapret 2, goshkow VPN и вариант «Без обхода».
...
|--------|----------------|-------------------|
| 🛡️ **Zapret** | Локальный DPI-обход без передачи всего трафика через VPN | Выбор сервисов, модификаций и `general`; ручная настройка или оркестратор |
...
| ⚪ **Без обхода** | Работа без Zapret, Zapret 2 и VPN | Можно оставить только вспомогательные компоненты |
...
| 🔁 **Быстрое переключение** | Смена Zapret, Zapret 2, VPN и режима без обхода без поиска настроек |
