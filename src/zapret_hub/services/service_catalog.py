...
SERVICE_PRESETS: tuple[ServicePreset, ...] = (
    ServicePreset("cloudflare", "Cloudflare", "Cloudflare", "CDN, DNS, WARP и серверная инфраструктура", "CDN, DNS, WARP, and edge infrastructure", "cloudflare.svg", "#f38020"),
    ServicePreset("discord", "Discord", "Discord", "Голосовой чат, сообщения и медиа Discord", "Voice chat, messaging, and Discord media", "discord.svg", "#5865f2"),
    ...
    ServicePreset("telegram-desktop", "Telegram", "Telegram", "Десктопное приложение Telegram для ПК", "Telegram desktop app for PC", "telegram.svg", "#26a5e4"),
    ServicePreset("roblox", "Roblox", "Roblox", "Игровая платформа и CDN Roblox", "Roblox platform and CDN", "roblox.svg", "#d8dde8"),
    ServicePreset("clouds", "Clouds", "Clouds", "Amazon CDN, CloudFront, BunnyCDN, OVH SAS и другие облачные CDN", "Amazon CDN, CloudFront, BunnyCDN, OVH SAS, and other cloud CDNs", "clouds.svg", "#66c0f4"),
    ServicePreset("tiktok", "TikTok", "TikTok", "Лента, видео, авторизация и CDN TikTok", "Feed, video playback, auth, and TikTok CDN", "tiktok.svg", "#25f4ee"),
    ...
    ServicePreset("epic-games", "Epic Games", "Epic Games", "Магазин, лаунчер, загрузки и сервисы Epic", "Store, launcher, downloads, and Epic services", "epicgames.svg", "#eef2f8"),
    ...
    ServicePreset("fortnite", "Fortnite", "Fortnite", "Матчмейкинг, лаунчер, загрузки и сервисы Epic", "Matchmaking, launcher, downloads, and Epic services", "fortnite.svg", "#7c5cff"),
    ServicePreset("spotify", "Spotify", "Spotify", "Веб-плеер, авторизация и музыкальный CDN", "Web player, auth, and music delivery CDN", "spotify.svg", "#1ed760"),
    ServicePreset("reddit", "Reddit", "Reddit", "Форумы, медиа, API и статические файлы Reddit", "Communities, media, API, and Reddit static files", "reddit.svg", "#ff4500"),
    ...
    ServicePreset("riot-games", "Riot Games", "Riot Games", "Клиент Riot, авторизация и игровые сервисы", "Riot client, authentication, and game services", "riotgames.svg", "#d32936"),
